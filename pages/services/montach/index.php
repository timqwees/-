...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<title>FAVORIT-STROY-SNAB - Инженерные системы</title>
	<meta name="description"
		content="FAVORIT-STROY-SNAB — Монтажные работы и установка оборудования. Профессиональный монтаж различных систем.">
