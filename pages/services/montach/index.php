...
<head>
	...
	<title>Монтаж инженерных систем — отопление, электрика | ФАВОРИТ-СТРОЙ-СНАБ</title>
	<meta name="description" content="Монтаж инженерных систем: отопление, водоснабжение, вентиляция, электрика.">
	...
	<meta name="keywords" content="монтажные работы, установка оборудования, монтаж, строительство, FAVORIT-STROY-SNAB">
	<meta name="author" content="TimQwees">
	<link rel="icon" type="image/png" sizes="32x32" href="/assets/image/favicon/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="/assets/image/favicon/favicon-16x16.png">
	<link rel="apple-touch-icon" sizes="180x180" href="/assets/image/favicon/apple-touch-icon.png">
	<link rel="manifest" href="/assets/image/favicon/site.webmanifest">
	<link rel="canonical" href="https://www.xn--h1aafj.xn--p1ai/pages/services/montach/" />
	<link rel="alternate" hreflang="ru" href="https://www.xn--h1aafj.xn--p1ai/pages/services/montach/" />
	<link rel="alternate" hreflang="x-default" href="https://www.xn--h1aafj.xn--p1ai/pages/services/montach/" />
	<!-- Open Graph / Facebook -->
	<meta property="og:locale" content="ru_RU">
	<meta property="og:site_name" content="ФАВОРИТ-СТРОЙ-СНАБ">
	<meta property="og:title" content="Монтаж инженерных систем — отопление, электрика">
	<meta property="og:description" content="Монтаж инженерных систем: отопление, водоснабжение, вентиляция, электрика.">
	...
	<meta property="og:url" content="https://www.xn--h1aafj.xn--p1ai/pages/services/montach/">
	<!-- Twitter -->
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:title" content="Монтаж инженерных систем — отопление, электрика">
	<meta name="twitter:description" content="Монтаж инженерных систем: отопление, водоснабжение, вентиляция, электрика.">
			...
			<div class="w-full flex flex-col lg:flex-row gap-8 items-start">
				...
				<div class="flex-1 min-w-0 bg-white rounded-[24px] border border-gray-100 shadow-sm p-6 md:p-8">
					...
					<p class="text-[15px] leading-relaxed text-gray-600 mb-6">
						Мы специализируемся на выполнении монтажных работ и установке различного оборудования. Наши
						специалисты отличаются высокой квалификацией, опытом и профессиональным подходом к работе.
						Предлагаем монтаж инженерных систем, оборудования и конструкций различной сложности.
						Гарантируем качество, соблюдение сроков и технических требований.
					</p>
...
<div
						...
						<?php endforeach; ?>
					<?php else: ?>
					<div class="col-span-full bg-emerald-50 border border-emerald-200 rounded-2xl p-8 text-center">
						<div class="text-emerald-700 font-semibold flex items-center justify-center gap-2"><i class="fa-solid fa-images"></i> Фото скоро появятся</div>
						<div class="text-sm text-gray-600 mt-1">Оставьте заявку — пришлем примеры в WhatsApp за 15 минут</div>
						<a href="#contact-form" class="inline-flex mt-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full px-5 py-2 text-sm font-semibold">Оставить заявку</a>
					</div>
					<?php endif; ?>
				...
				<div id="contact-form" class="w-full lg:w-[380px] shrink-0 bg-white rounded-[24px] border border-gray-100 shadow-[0_12px_32px_rgba(15,23,42,.08)] p-6 sticky top-24">
