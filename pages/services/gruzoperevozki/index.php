...
// Изображения для грузоперевозок
$modulImages = [
	'https://фсс.рус/assets/image/services/Грузоперевозки/1.jpg',
	'https://фсс.рус/assets/image/services/Грузоперевозки/2.jpg',
	'https://фсс.рус/assets/image/services/Грузоперевозки/3.jpg',
	'https://фсс.рус/assets/image/services/Грузоперевозки/4.jpg',
	'https://фсс.рус/assets/image/services/Грузоперевозки/5.avif',
];
...
<head>
	...
	<title>Грузоперевозки по Москве и России — ФАВОРИТ-СТРОЙ-СНАБ</title>
	<meta name="description" content="Грузоперевозки авто и ЖД транспортом. Доставка стройматериалов, спецтехника, быстро и надёжно.">
	...
	<meta name="keywords"
		content="грузоперевозки, перевозка грузов, транспортировка, FAVORIT-STROY-SNAB, доставка, логистика">
	<meta name="author" content="TimQwees">
	<link rel="icon" type="image/png" sizes="32x32" href="/assets/image/favicon/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="/assets/image/favicon/favicon-16x16.png">
	<link rel="apple-touch-icon" sizes="180x180" href="/assets/image/favicon/apple-touch-icon.png">
	<link rel="manifest" href="/assets/image/favicon/site.webmanifest">
	<link rel="canonical" href="https://www.xn--h1aafj.xn--p1ai/pages/services/gruzoperevozki/" />
	<link rel="alternate" hreflang="ru" href="https://www.xn--h1aafj.xn--p1ai/pages/services/gruzoperevozki/" />
	<link rel="alternate" hreflang="x-default" href="https://www.xn--h1aafj.xn--p1ai/pages/services/gruzoperevozki/" />
	<!-- Open Graph / Facebook -->
	<meta property="og:locale" content="ru_RU">
	<meta property="og:site_name" content="ФАВОРИТ-СТРОЙ-СНАБ">
	<meta property="og:title" content="Грузоперевозки по Москве и России — ФАВОРИТ-СТРОЙ-СНАБ">
	<meta property="og:description" content="Грузоперевозки авто и ЖД транспортом. Доставка стройматериалов, спецтехника, быстро и надёжно.">
	...
	<meta property="og:url" content="https://www.xn--h1aafj.xn--p1ai/pages/services/gruzoperevozki/">
	<!-- Twitter -->
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:title" content="Грузоперевозки по Москве и России — ФАВОРИТ-СТРОЙ-СНАБ">
	<meta name="twitter:description"
		content="Надежные грузоперевозки по России. Оперативная доставка, современные автомобили, профессиональные водители.">
			...
			<div class="w-full p-6 bg-white flex flex-col lg:flex-row gap-10 justify-between">
				...
				<div class="relative mb-10 ">
					...
					<p class="text-gray-600 tracking-wide mb-5">
						Компания FAVORIT-STROY-SNAB предоставляет услуги по грузоперевозкам по всей России. Мы
						осуществляем перевозку различных видов грузов — от строительных материалов до оборудования и
						мебели. Наш автопарк состоит из современных и надежных автомобилей, а опытные водители
						обеспечивают безопасность и своевременность доставки. Индивидуальный подход к каждому клиенту,
						прозрачные условия и конкурентные цены.
					</p>


					<!-- ######################################USLUGI################################################## -->

					<h3 class="text-xl text-black font-bold mb-5 text-gray-900">Наши услуги:</h3>
							...
							<div
								...
								<div class="w-full aspect-[4/1] relative">
									<img class="rounded-2xl object-cover bg-center w-full h-[120px] transition-transform duration-500 group-hover:scale-105"
										src="<?php echo $img; ?>" alt="Грузоперевозки">
									<span
					...
					<form action="#" method="post" class="space-y-4" novalidate>
						...
						<div class="flex flex-col sm:flex-row justify-between items-center gap-4">
							...
							<span class="text-[12px] text-green-700">Отправьте заявку и получите
								консультацию по грузоперевозкам</span>
						</div>
					</form>
				</div>
