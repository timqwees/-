...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<title>FAVORIT-STROY-SNAB - Генераторные установки</title>
	<meta name="description"
		content="FAVORIT-STROY-SNAB — Поставка и монтаж генераторных установок. Надежное электроснабжение для предприятий.">
