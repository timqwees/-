...
$modulImages = [
	'/assets/image/services/МТЗ/n_pdc5b2tgyjydxTAt_7ev1rBBFN26bwbq4796VCT5BHICCidmF-CnC59nv7sETn82ryDyaC4PqRG_nijl-iaTBU.jpg',
	...
	'/assets/image/services/МТЗ/MNAEHRcw27qk0buSmkKQyg5y30hnigc-zXc68ylPagQIfUWmRJj2PI2ngGCso3cNr1Ar9H_JQ-Nm5IJd7VtriDPb.jpg',
	'/assets/image/services/МТЗ/XK_gv3g8LacSwhlUCa7rOPn9wbbuX3mt104w9q_E5aEv7gYG4ZZfRvCI0aSGn7Bkm3X5FNnoX7Vh9GSfauPzynYX.jpg',
	'/assets/image/services/МТЗ/WaFjTiAvWrSSDsQfVMmZP8f_4Ypmss9_SmOCEwERQsPFGqv8usViLdYzhYVfY45UOX3bjGEDr8lXHiVZam0Gf4w1.jpg',
	'/assets/image/services/МТЗ/WhatsApp Image 2025-07-01 at 10.05.48.jpeg',
	'/assets/image/services/МТЗ/WhatsApp Image 2025-07-01 at 10.05.47-2.jpeg',
	'/assets/image/services/МТЗ/WhatsApp Image 2025-07-01 at 10.05.28 (1).jpeg',
	'/assets/image/services/МТЗ/WhatsApp Image 2025-07-01 at 10.05.28.jpeg',
	'/assets/image/services/МТЗ/WhatsApp Image 2025-07-01 at 10.03.41.jpeg',
	'/assets/image/services/МТЗ/WhatsApp Image 2025-07-01 at 10.02.14.jpeg',
	'/assets/image/services/МТЗ/WhatsApp Image 2025-07-01 at 10.02.10.jpeg',
];
		...
		<div class="container mx-auto">
			...
			<div class="w-full flex flex-col lg:flex-row gap-8 items-start">
				...
				<div class="flex-1 min-w-0 bg-white rounded-[24px] border border-gray-100 shadow-sm p-6 md:p-8">
					<nav class="flex items-center gap-1.5 text-xs text-gray-500 mb-4"><a href="/index.php" class="hover:text-emerald-700">Главная</a><span class="opacity-40">/</span><a href="/pages/uslugi/uslugi.php" class="hover:text-emerald-700">Услуги</a><span class="opacity-40">/</span><span class="text-gray-900 font-medium">Postavka</span></nav>
