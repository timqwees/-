...
$modulImages = [
	'https://фсс.рус/assets/image/services/Спецтехника/1.jpg',
	'https://фсс.рус/assets/image/services/Спецтехника/2.jpg',
	'https://фсс.рус/assets/image/services/Спецтехника/3.jpg',
];
				...
				<div class="relative mb-10 ">
					...
					<div
						...
						foreach ($modulImages as $i => $img): ?>
							<!-- items -->
							<div
								class="flex flex-col items-center w-full p-4 pb-10 border-2 via-white rounded-lg shadow-xl transition-all duration-500 cursor-pointer hover:scale-105 hover:shadow-2xl group relative overflow-hidden view">
								<div class="w-full aspect-[4/1] relative">
									<img class="rounded-2xl object-cover bg-center w-full h-[120px] transition-transform duration-500 group-hover:scale-105"
										src="<?php echo $img; ?>" alt="<?php echo $techNames[$i] ?? 'Спецтехника'; ?>">
									<span
