...
<head>
	...
	<title>Проектирование зданий и сооружений | ФАВОРИТ-СТРОЙ-СНАБ</title>
	<meta name="description" content="Проектирование БВЗ и капитальных строений: чертежи, расчёты, согласование.">
	...
	<meta name="keywords" content="проектирование, архитектура, инженерные решения, строительство, FAVORIT-STROY-SNAB">
			...
			<div class="w-full flex flex-col lg:flex-row gap-8 items-start">
				...
				<div class="flex-1 min-w-0 bg-white rounded-[24px] border border-gray-100 shadow-sm p-6 md:p-8">
					...
					<p class="text-[15px] leading-relaxed text-gray-600 mb-6">
						Мы специализируемся на проектировании зданий и сооружений различного назначения. Наши проекты
						отличаются инновационными решениями, функциональностью и соответствием всем строительным нормам.
						Предлагаем полный спектр проектных услуг - от архитектурного проектирования до инженерных
						систем.
						Гарантируем качество, точность и профессиональный подход к каждому проекту.
					</p>
