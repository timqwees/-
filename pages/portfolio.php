...
<head>
	...
	<title>Портфолио — Реализованные объекты | ФАВОРИТ-СТРОЙ-СНАБ</title>
	<meta name="description" content="Портфолио выполненных объектов: фото и видео школ, складов, АБК, общежитий, навесов. Более 50 проектов.">
	<meta name="keywords"
		content="портфолио, модульные здания, быстровозводимые здания, проекты, фото, видео, Фаворит-Строй-Снаб, строительство, домостроение, FAVORIT-STROY-SNAB, строительные услуги, материалы">
...
<!-- end -->
	...
	<meta property="og:title" content="Портфолио — Реализованные объекты">
	...
	<meta property="og:url" content="https://www.xn--h1aafj.xn--p1ai/pages/portfolio.php">
	<!-- Twitter -->
	...
	<!-- canonical -->
	<link rel="canonical" href="https://www.xn--h1aafj.xn--p1ai/pages/portfolio.php" />
	<link rel="alternate" hreflang="ru" href="https://www.xn--h1aafj.xn--p1ai/pages/portfolio.php" />
	<link rel="alternate" hreflang="x-default" href="https://www.xn--h1aafj.xn--p1ai/pages/portfolio.php" />

	<!-- Swiper Slider for Banner -->
	<script defer="true" src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>
	<style>
		[data-theme='dark'] .hanburger_line,
		[data-theme='dark'] .close_line_menu_one,
		[data-theme='dark'] .close_line_menu_two,
		[data-theme='dark'] .underblock_line::after,
...
<body class="bg-gray-50 font-sans text-gray-800">
	...
	<main class="container mx-auto px-4 py-12">
		...
		<!-- Школа фото -->
		<section class="mb-16 px-5 py-5 rounded-[15px]">
			<h2 class="text-2xl font-bold mb-6">Школа (кап. ремонт и поставка мебели)</h2>
			<div class="swiper school-swiper">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide view"><video
							src="/assets/image/services/Школа фото/WhatsApp Video 2025-07-06 at 13.38.37.mp4" controls
							loop playsinline muted autoplay></video><span
							class="absolute bottom-2 right-4 text-xs text-white bg-black/50 px-2 py-1 rounded">видео
							1</span></div>
					<div class="swiper-slide view"><video
							src="/assets/image/services/Школа фото/WhatsApp Video 2025-07-06 at 13.40.00-2.mp4" controls
							loop playsinline muted autoplay></video><span
							class="absolute bottom-2 right-4 text-xs text-white bg-black/50 px-2 py-1 rounded">видео
							2</span></div>
				</div>
		...
		<!-- Мусор БАК -->
		<section class="mb-16 px-5 py-5 rounded-[15px]">
			<h2 class="text-2xl font-bold mb-6">Мусорные баки (поставка)</h2>
			<div class="swiper trash-swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide view"><img
					...
					<div class="swiper-slide view"><img
							...
							3</span></div>
					<div class="swiper-slide view"><video
							src="/assets/image/services/Мусор БАК/WhatsApp Video 2025-07-07 at 17.38.28-3.mp4" controls
							loop playsinline muted autoplay></video><span
							class="absolute bottom-2 right-4 text-xs text-white bg-black/50 px-2 py-1 rounded">видео
							1</span></div>
					<div class="swiper-slide view"><video
							src="/assets/image/services/Мусор БАК/WhatsApp Video 2025-07-07 at 17.38.28-2.mp4" controls
							loop playsinline muted autoplay></video><span
							class="absolute bottom-2 right-4 text-xs text-white bg-black/50 px-2 py-1 rounded">видео
							2</span></div>
					<div class="swiper-slide view"><video
							src="/assets/image/services/Мусор БАК/WhatsApp Video 2025-07-07 at 17.38.28.mp4" controls
							loop playsinline muted autoplay></video><span
							class="absolute bottom-2 right-4 text-xs text-white bg-black/50 px-2 py-1 rounded">видео
							3</span></div>
				</div>
		...
		<!-- Общежитие -->
		<section class="mb-16 px-5 py-5 rounded-[15px]">
			<h2 class="text-2xl font-bold mb-6">Общежитие</h2>
			<div class="swiper hostel-swiper">
				<div class="swiper-wrapper">
		...
		<!-- Склады -->
		<section class="mb-16 px-5 py-5 rounded-[15px]">
			<h2 class="text-2xl font-bold mb-6">Склады</h2>
			<div class="swiper sklads-swiper">
				<div class="swiper-wrapper">
		...
		<!-- Генераторные -->
		<section class="mb-16 px-5 py-5 rounded-[15px]">
			<h2 class="text-2xl font-bold mb-6">Генераторные</h2>
			<div class="swiper gens-swiper">
				<div class="swiper-wrapper">
		...
		<!-- АБК -->
		<section class="mb-16 px-5 py-5 rounded-[15px]">
			<h2 class="text-2xl font-bold mb-6">АБК</h2>
			<div class="swiper abk-swiper">
				<div class="swiper-wrapper">
	...
	<script>
		...
		[
			'.school-swiper', '.trash-swiper', '.hostel-swiper', '.mtz-swiper', '.navesy-swiper', '.gascomp-swiper', '.aircomp-swiper', '.sklads-swiper', '.gens-swiper', '.abk-swiper'
		].forEach(cls => {
			new Swiper(cls, {
				slidesPerView: 1,
				spaceBetween: 24,
